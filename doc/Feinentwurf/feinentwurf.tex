...
Als Beispiel hier eine mögliche Worlddarstellung bei der der aktuelle Spieler am Zug ist, 5 schwarze und 8 weiße Steine geschlagen wurden und der vorherige Spieler nicht gepasst hat. Der Spielstand ist zur Übersicht vereinfacht:
\begin{quotation}
 '(play '(spielstand) '(5 . 8) false)
\end{quotation}
