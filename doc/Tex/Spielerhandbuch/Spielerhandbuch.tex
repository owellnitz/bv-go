...
\begin{figure}[ht]
\centering \includegraphics[width=0.3\textwidth]{images/erlaubterselbstmord}
...
\begin{figure}[ht]
\centering \includegraphics[width=0.3\textwidth]{images/geschlagen}
...
F"ur den Betrieb des Programmes muss die Entwicklungsumgebung DrRacket\footnote{\label{note2}{\url{https://download.racket-lang.org/}}} installiert werden. Zudem wird die VigRacket-Bibliothek\footnote{\label{note3}{\url{https://github.com/BSeppke/vigracket}}} f"ur die Bildauswertung ben"otigt.
...
Die Clients werden über den Pfad go\textbackslash{}src\textbackslash{}go\_client.rkt gestartet. Sie d"urfen allerdings erst gestartet werden, wenn der Server bereits vollst"andig gestartet ist. Wird der Client ausgeführt, werden zwei Instanzen gestartet, welche sich am lokalen Server anmelden. Der Client, der sich als erstes anmeldet, erhält einige Auswahlmöglichkeiten zum Spielstart.\\\\
...
\begin{figure}[ht]
\centering \includegraphics[width=1.0\textwidth]{images/Vorgabe}
...
\begin{figure}[ht]
\centering \includegraphics[width=0.6\textwidth]{images/Spielbrett}
...
\begin{figure}[ht]
\centering \includegraphics[width=0.8\textwidth]{images/Bildname}
...
\begin{figure}[ht]
\centering \includegraphics[width=0.8\textwidth]{images/spielen}
...
\begin{figure}[ht]
\centering \includegraphics[width=0.8\textwidth]{images/auswertung}
